...
public class GraphOverlay {
	...
	/**
	 * Old method used for having the user choose the needed Tif file from their 
	 * files. No longer used because the plugin prompts the user at the beginning
	 * of the program to select their Tif file.
	 */
	public void loadTif() {
	...
	/**
	 * Overlays LingDong's chunks from LingDong's skeletonization algorithm on the 
	 * root system. This was used to help understand how LingDong's algorithm breaks
	 * the root system into lines.
	 * 
	 * 
	 * @param graph : graph object generated from LingDong's skeletonization algorithm.
	 * @param cp : ColorProcessor object of the root system.
	 * @param skeleton : Skeleton object generated by the root system.
	 */
	...
	/**
	 * Converts a chunk from LingDong's skeletonization algorithm into an Roi. Used 
	 * to overlay the chunk onto the root system image. Note the Roi is a rectangle 
	 * outline, not filled in.
	 * 
	 * 
	 * @param chunk : chunk from LingDong's skeletonization algorithm.
	 * @return : Returns an Roi representation of the chunk.
	 */
	...
	/**
	 * Overlays the skeleton of the root system onto the image.
	 * If the nodules have been added to the RootGraph object, it will overlay them
	 * also. It overrides this.OverlayedGraph with the skeleton.
	 *  
	 * @param graph : graph of the root system.
	 * @param cp : ColorProcessor of the root system.
	 * 
	 */
	...
	/**
	 * Overlays the nodules onto the provided image. 
	 * 
	 * @param graph : graph of the root system.
	 * @param skellyMap : image (presumably of the root system) to overlay the 
	 * nodules onto.
	 */
