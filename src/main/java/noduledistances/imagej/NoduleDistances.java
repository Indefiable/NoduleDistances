...
/**
 * Code that converts the RGB values of an image processor to YUV values. 
 * Algorithm found using ChatGPT and verified by checking online.
 * 	
 * @param cp : ImageProcess object to convert
 * @return : ImagePlus object that has the YUV values.
 */
...
/**
 * Method that converts the provided ImageProcess data to RGB values. Assumes the input
 * is currently storing YUV values.	
 * @param ipYUV : ImageProcessor object that has YUV values at each pixel.
 * @return : a ColorProcessor object that stores RGB values at each pixel.
 */
